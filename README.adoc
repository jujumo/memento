...
, image:math/icon_geometry.svg["geometry"] link:math/frames.adoc[frames]
...
, link:misc/docker.adoc[Docker]
, link:misc/docker_app.adoc[Docker app]
...
, link:misc/gitextensions.adoc[gitextensions]
